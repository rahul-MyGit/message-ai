...
import CreateAutomation from '@/components/global/Navbar/CreateAutomation'
import React from 'react'
import AutomationList from '@/components/global/automations/AutomationList'

const page = () => {
  //TODO: connect to real automations list here
  return (
