...
type PAGE_ICON_PROPS = {
    [page in string] : React.ReactNode
}

const {AutomationDuoToneBlue, ContactsDuoToneBlue, RocketDuoToneBlue, SettingsDuoToneWhite,HomeDuoToneBlue} = Icons();

const PAGE_ICON: PAGE_ICON_PROPS = {
